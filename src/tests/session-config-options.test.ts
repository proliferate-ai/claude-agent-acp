...
type TestModelCapabilitiesById = Record<string, TestModelCapabilities>;

const NO_REASONING_MODEL_CAPABILITIES: TestModelCapabilitiesById = Object.fromEntries(
  MOCK_MODELS.availableModels.map((model) => [
    model.modelId,
    {
...
function createConfigOptions(params?: {
  ...
  effortCurrentValue?: "low" | "medium" | "high" | "xhigh";
